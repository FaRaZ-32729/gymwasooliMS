            ...
            <nav className="max-w-[1400px] mx-auto px-6 md:px-12 flex justify-between items-center h-[12vh]">
                ...
                <ul className="hidden md:flex items-center gap-x-8 font-medium text-white">
                    <li>
                        <NavLink
                            to="/"
                            className="relative hover:text-[#ED563B] transition-colors duration-300 
                            after:content-[''] after:absolute after:w-0 after:h-[2px] after:bg-[#ED563B] 
                ...
                {/* Mobile Menu Button */}
                <button
                    className="text-3xl text-[#ED563B] md:hidden"
                    onClick={toggleMenu}
                >
                ...
                {/* Mobile Menu */}
                <div
                    className={`fixed top-0 left-0 h-screen w-[70%] bg-gradient-to-br from-[#ED563B] to-[#ED563B] 
                ...
                >
                    ...
                    <NavLink
                        to="/request-demo"
                        onClick={toggleMenu}
                        className="bg-white text-[#ED563B] md:px-5 py-2 rounded-full text-center font-semibold 
